...
def load_data():
    ...
    input_signal_type = ["body_acc_x_", "body_acc_y_", "body_acc_z_", "body_gyro_x_",
            "body_gyro_y_", "body_gyro_z_", "total_acc_x_", "total_acc_y_", "total_acc_z_"]

    train_files = [folder + 'train/' + 'Inertial Signals/' + item + 'train.txt' for item in input_signal_type]
    test_files = [folder + 'test/' + 'Inertial Signals/' + item + 'test.txt' for item in input_signal_type]
    train_y = folder + 'train/y_train.txt'
    test_y = folder + 'test/y_test.txt'

    X_train = format_data_x(train_files)
    X_test = format_data_x(test_files)
    Y_train = format_data_y(train_y)
    Y_test = format_data_y(test_y)
